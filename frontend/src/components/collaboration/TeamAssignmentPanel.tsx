        ...
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            ...
            {currentAssignment ? (
              ...
              <p className="text-xs text-surface-400">Route to team queue</p>
            )}
          </div>
        </div>
                    ...
                    return (
                      ...
                      >
                        {isSuggested && !isSelected && (
                          <span className="absolute -top-2 -right-2 px-1.5 py-0.5 rounded text-[10px] bg-primary-500 text-white">
                            Suggested
                          </span>
                        )}
