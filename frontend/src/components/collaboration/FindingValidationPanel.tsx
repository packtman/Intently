...
import type { Finding, ValidateFindingRequest } from '../../types'
      ...
      >
        <div className="flex items-center gap-3">
          ...
          >
            {isLoadingValidation ? (
              ...
              (() => {
                ...
                const color = statusConfig[currentStatus as ValidationStatus]?.color || 'surface'
                const colorClass =
                  color === 'green'
                    ? 'text-green-400'
                    : color === 'red'
          ...
          <div className="text-left">
            ...
            {isValidated && validation && 'validator_team' in validation && (
            ...
            <div className="p-4 pt-0 space-y-4 border-t border-surface-700">
              ...
              {isValidated && validation && 'notes' in validation && validation.notes && (
                <div className="p-3 rounded-lg bg-surface-800/50">
                  <p className="text-xs text-surface-400 mb-1">Validation Notes</p>
                  <p className="text-sm text-surface-300">{validation.notes}</p>
                    ...
                    ([status, config]) => {
                      ...
                      return (
                        <button
                          ...
                          className={`
                            p-3 rounded-lg border border-surface-700 text-left transition-all
                            ${isSelected ? colorClasses[config.color as keyof typeof colorClasses] : `text-surface-400 ${colorClasses[config.color as keyof typeof colorClasses]}`}
                          `}
                        >
