    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-neon-500/20 to-aurora-500/20 flex items-center justify-center">
            <Lightbulb className="w-4 h-4 text-neon-400" />
          </div>
            ...
            <div className="p-4 pt-0 space-y-4 border-t border-void-700">
              ...
              {isLoading ? (
                <div className="flex items-center justify-center py-4">
                  <Loader2 className="w-5 h-5 text-void-400 animate-spin" />
                </div>
              ) : existingFeedback.length > 0 && (
                <div className="space-y-2">
                  <p className="text-xs font-medium text-void-400">Previous Feedback</p>
              ...
              {feedbackType && (
                ...
                >
                  ...
                  <div className="p-3 rounded-lg bg-void-800/50 border border-void-700">
                    <p className="text-xs text-void-400 mb-1">Current AI Assessment</p>
                        ...
                        <button
                          ...
                          className={`p-3 rounded-lg border text-left transition-all ${
                            expertValue === 'false_positive'
                              ...
                              : 'border-void-700 text-void-400 hover:bg-green-500/10'
                          }`}
                        >
                        ...
                        <button
                          ...
                          className={`p-3 rounded-lg border text-left transition-all ${
                            expertValue === 'not_applicable'
                              ...
                              : 'border-void-700 text-void-400 hover:bg-blue-500/10'
                          }`}
                        >
                        ...
                        {severityOptions.map((sev) => (
                          <button
                            ...
                            className={`
                              ...
                              ${expertValue === sev
                                ? 'bg-neon-500/20 border-neon-500/30 text-neon-400'
                                : 'border-void-700 text-void-400 hover:bg-void-700'
                              }
  ...
  return (
    <div className={`p-3 rounded-lg ${colors.bg} border ${colors.border}`}>
      ...
      <div className="flex items-center gap-2 text-sm mb-2">
        <span className="text-void-400 line-through">{feedback.original_value}</span>
        <ArrowRight className="w-3 h-3 text-void-500" />
        <span className="text-white font-medium">{feedback.expert_value}</span>
      </div>
      <p className="text-xs text-void-300">{feedback.reasoning}</p>
...
export function FeedbackCountBadge({ count }: { count: number }) {
  ...
  return (
    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-neon-500/20 text-neon-400 text-xs">
